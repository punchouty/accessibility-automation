...
public final class ContrastChecker {
     ...
     */
    public static double getContrastRatio(final Color fgColor, final Color bgColor) {
    ...
    public static double getContrastRatio5DigitRound(final Color fgColor, final Color bgColor) {
        double fgLuminosity = getLuminosity(fgColor);
        double bgLuminosity = getLuminosity(bgColor);
        if (fgLuminosity > bgLuminosity) {
